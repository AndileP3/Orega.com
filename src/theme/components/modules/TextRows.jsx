...
export const fields = (
  <ModuleFields>
    ...
    <TextField name="row1_paragraph" label="Row 1 Paragraph" default="Propel your business forward with our private managed offices." />
    ...
    <TextField name="row2_paragraph" label="Row 2 Paragraph" default="Book purpose-built meeting rooms in easy-to-reach locations." />
    ...
    <TextField name="row3_paragraph" label="Row 3 Paragraph" default="Enhance your presence without the cost of a physical office." />
