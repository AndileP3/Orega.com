// src/theme/components/modules/TextRows.jsx
...
export function Component({ fieldValues }) {
  const rows = [
    ...
    },
    {
      ...
      paragraph: fieldValues.row2_paragraph || "Convey a professional image from the get-go - book a purpose-built meeting room in easy-to-reach locations. Our Concierge team will take care of every need while you host a successful meeting.",
      buttonText: fieldValues.row2_button,
      serviceType: 'meeting',
    ...
    },
    {
      ...
      paragraph: fieldValues.row3_paragraph || "Enhance your business presence without the cost of a physical office. Our virtual office packages are affordable and support your business growth with recognised, prestigious addresses. Get the best of both worlds by combining a home office with a virtual office to create a professional impression or use our business addresses to test a new market.",
      buttonText: fieldValues.row3_button,
      serviceType: 'virtual',
  ...
  return (
    <section className={styles.container}>
        ...
        >
          <div className={styles.innerRow}>
            <div className={styles.left}>
              ...
              {/* Button stays an Island and triggers the modal Island */}
              <Island
                module={ButtonIsland}
                fieldValues={{
            ...
            <div className={styles.right}>
              {row.accentImage && (
                <img src={row.accentImage} alt="Accent" className={styles.accentImage} />
              )}
              {row.image && (
      ...
      {/* One modal island instance per module */}
      <Island
        module={ServiceModalIsland}
        fieldValues={{ hubdbTableId: 128385095, portalId: 47574277 }}
      />
    </section>
  );
}
...
export const fields = (
  <ModuleFields>
    ...
    <TextField name="row1_paragraph" label="Row 1 Paragraph" />
    ...
    <TextField name="row2_paragraph" label="Row 2 Paragraph"  />
    ...
    <TextField name="row2_bgColor" label="Row 2 Background Color" default="#07374e" />

    {/* Row 3 Fields */}
    <TextField name="row3_heading" label="Row 3 Heading" default="Virtual offices" />
    <TextField name="row3_paragraph" label="Row 3 Paragraph" />
