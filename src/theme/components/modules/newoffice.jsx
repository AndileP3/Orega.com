...
const DEFAULT_BG_URL =
  'https://2947606.fs1.hubspotusercontent-na1.net/hub/2947606/hubfs/OregaEightyStrand_BreakoutSpace_Courtyard-1.jpg?width=2000&height=1125&name=OregaEightyStrand_BreakoutSpace_Courtyard-1.jpg';
    ...
    >
      <div className={styles.overlayBox}>
        ...
        <Island
          ...
          fieldValues={{
            buttonText,
            buttonLink: "/orega.com-services", // dynamic redirect link
          }}
        />
      </div>
    </section>
